                      ...
                      WORD32 i4_is_last_ctb_y)
{
    ...
    if (ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME && 0 == i4_is_last_ctb_x)
    {
    ...
    if (ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME && 0 == i4_is_last_ctb_y)
    {
